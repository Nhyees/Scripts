...
output_folder = input("\nAppuie sur Entrée ou entre le nom du dossier de téléchargement des vidéos : ").strip() or "videos"
...
# Liste pour stocker les vidéos ayant échoué à être téléchargées
failed_videos = []
...
for index in range(total_videos):
    ...
    try:
        ...
        failed_videos.append(video_name)  # Ajouter le nom de la vidéo ayant échoué

    print("* * *")  # Étoile après chaque vidéo traitée >.<

# Afficher les vidéos ayant échoué
if failed_videos:
    print("\nLa/les vidéos suivante(s) n'a/ont pas pu être téléchargée(s) à cause d'une erreur :")
    for video in failed_videos:
        print(f"- {video}")
else:
    print("\nToutes les vidéos ont été téléchargées avec succès !")
